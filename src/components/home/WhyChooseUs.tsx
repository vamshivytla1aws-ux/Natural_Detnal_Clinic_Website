      ...
      <div className="container-premium">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-charcoal-500 font-sans text-lg mb-8 max-w-md">
            ...
            <div className="grid sm:grid-cols-2 gap-8 lg:gap-12">
              {principles.map((p) => (
                <div key={p.num} className="group">
                  <div className="font-serif text-[2.5rem] text-sage-400 mb-2 group-hover:text-forest-600 transition-colors">
                    {p.num}
                  </div>
                  <h3 className="font-sans font-bold text-charcoal-700 text-lg mb-2">
                    {p.title}
                  </h3>
