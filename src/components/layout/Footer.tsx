...
export function Footer() {
  ...
  return (
    <footer className="bg-forest-700 text-white/90" role="contentinfo">
      {/* Main Footer */}
      <div className="container-premium py-14 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-5 group" aria-label={`${CLINIC.name} - Home`}>
              <div className="relative w-12 h-12 bg-white/10 rounded-full p-1 group-hover:bg-white/20 transition-colors">
                <Image
                  src="/images/logo.png"
              ...
              <div>
                ...
                <p className="text-champagne-300 text-xs tracking-widest uppercase">Clinic</p>
              </div>
            </Link>
            <p className="text-white/70 text-sm leading-relaxed mb-5">
              Premium dental care delivered with compassion and expertise in Ramachandrapuram, Hyderabad. Your smile is our greatest achievement.
            </p>
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                aria-label="WhatsApp"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#25D366]/40 flex items-center justify-center transition-colors duration-200"
              >
                <WhatsAppIcon />
              </a>
            </div>
          ...
          <div>
            <h3 className="text-white font-semibold text-sm tracking-widest uppercase mb-5 flex items-center gap-2">
              <span className="w-5 h-px bg-champagne-400" />
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <Phone size={15} className="mt-0.5 flex-shrink-0 text-champagne-400" />
                  <span className="text-sm">{CLINIC.contact.phoneDisplay}</span>
                </a>
              </li>
              <li>
                <a
                  href={CLINIC.contact.emailHref}
                  className="flex items-start gap-3 text-white/70 hover:text-white transition-colors duration-200"
                  aria-label={`Email ${CLINIC.contact.email}`}
                >
                  <Mail size={15} className="mt-0.5 flex-shrink-0 text-champagne-400" />
                  <span className="text-sm break-all">{CLINIC.contact.email}</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <MapPin size={15} className="mt-0.5 flex-shrink-0 text-champagne-400" />
              ...
              <li>
                <div className="flex items-start gap-3 text-white/70">
                  <Clock size={15} className="mt-0.5 flex-shrink-0 text-champagne-400" />
                  <div className="text-sm">
                    <p>{CLINIC.hours.weekdaysShort}</p>
                    <p>{CLINIC.hours.sundayShort}</p>
                  </div>
                </div>
              </li>
            </ul>
      ...
      <div className="border-t border-white/10">
        <div className="container-premium py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-white/40 text-xs flex items-center gap-1">
            Made with <Heart size={11} className="text-red-400" /> for better smiles
          </p>
