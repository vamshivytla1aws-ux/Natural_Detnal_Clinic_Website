...
export const SERVICES: Service[] = [
  {
    ...
    description: "Painless, precise root canal treatment to save infected teeth and eliminate severe toothache.",
    overview:
      "Root Canal Treatment (RCT) is a procedure that removes infected pulp from inside a tooth, cleans and seals the canal, and saves the natural tooth. At Natural Dental Clinic, we use modern techniques and anaesthesia to make the procedure virtually painless and highly effective.",
    symptoms: [
    ...
    faqs: [
      { question: "Is root canal treatment painful?", answer: "With modern anaesthesia, the procedure is very comfortable. Most patients report less pain than expected — often no more than a simple filling." },
      { question: "How long does it take?", answer: "Most root canal procedures are completed in 1–2 visits, each lasting 60–90 minutes." },
      { question: "How long does the treated tooth last?", answer: "With proper care and a quality crown, a root canal treated tooth can last a lifetime." },
      { question: "What happens if I delay treatment?", answer: "Untreated infections can spread to other teeth, jawbone, and in severe cases cause serious systemic health issues." },
    ],
  ...
  },
  {
    ...
    category: "Restorative",
    description: "State-of-the-art dental implants that look, feel, and function exactly like natural teeth.",
    overview:
      "Dental implants are titanium posts surgically placed into the jawbone, acting as artificial tooth roots. They support crowns, bridges, or dentures, providing a permanent, stable, and beautiful tooth replacement solution. Natural Dental Clinic offers high-quality implant treatments with excellent aesthetics and long-term durability.",
    symptoms: [
    ...
    faqs: [
      { question: "Am I suitable for dental implants?", answer: "Most adults with good general health and sufficient jawbone are suitable. We assess each patient individually." },
      { question: "How long do implants last?", answer: "With proper oral hygiene, dental implants can last 20–30 years or even a lifetime." },
      { question: "Is the procedure painful?", answer: "The surgery is done under local anaesthesia. Mild soreness after is manageable with medication." },
      { question: "How do I care for implants?", answer: "Treat them like natural teeth — brush twice daily, floss regularly, and attend routine dental check-ups." },
    ],
