...
export const SERVICES: Service[] = [
  {
    ...
    process: [
      ...
      { step: "Local Anaesthesia", description: "The area is numbed completely to ensure you are comfortable during the procedure." },
  ...
  },
  {
    ...
    overview:
      "Professional teeth whitening is a cosmetic treatment that lightens tooth colour by removing stains and discolouration. At Natural Dental Clinic, we offer supervised whitening treatments that deliver noticeable results, while ensuring your comfort and care.",
    symptoms: [
    ...
    faqs: [
      ...
      { question: "Is it safe?", answer: "Yes, professional whitening under dental supervision is considered very safe. We monitor your gum health throughout the procedure." },
  ...
  },
  {
    ...
    description: "Modern orthodontic solutions for an aligned, healthy smile at any age.",
    overview:
      "Orthodontic treatment corrects misaligned teeth and jaws, improving both aesthetics and oral health. Natural Dental Clinic offers modern braces and orthodontic solutions for children, teens, and adults. Straight teeth are often easier to clean and less prone to damage over time.",
    symptoms: [
    ...
    process: [
      ...
      { step: "Retention Phase", description: "After braces are removed, retainers help maintain the new tooth positions long-term." },
    ],
    faqs: [
      ...
      { question: "Are braces painful?", answer: "Some mild discomfort is normal after adjustments. This usually subsides within a few days and is easily managed." },
  ...
  },
  {
    ...
    description: "Expert wisdom tooth extraction designed to relieve pain and prevent future complications.",
    overview:
      "Wisdom teeth (third molars) often erupt incorrectly, causing pain, crowding, infection, or damage to adjacent teeth. Timely removal can prevent serious complications. At Natural Dental Clinic, we perform wisdom tooth extractions with a focus on patient comfort and a smooth recovery.",
    symptoms: [
    ...
    process: [
      ...
      { step: "Anaesthesia", description: "Local anaesthesia helps ensure the procedure is comfortable." },
      { step: "Careful Extraction", description: "The tooth is carefully loosened and removed with minimal trauma to surrounding tissue." },
    ...
    faqs: [
      { question: "Does wisdom tooth removal hurt?", answer: "The procedure is designed to be comfortable under local anaesthesia. Mild soreness for a few days after is normal and managed with medication." },
      { question: "How long is the recovery?", answer: "Most patients recover well within 7–10 days. Following aftercare instructions ensures smooth healing." },
  ...
  },
  {
    ...
    category: "Preventive",
    description: "Warm, child-friendly dental care that helps build healthy habits and happy smiles from an early age.",
    overview:
    ...
    benefits: [
      "Helps establish healthy dental habits early",
      "Aims to prevent cavities and tooth decay",
  ...
  },
  {
    ...
    description: "Gum disease management and therapy to help restore gum health and protect your teeth.",
    overview:
      "Healthy gums are the foundation of a healthy smile. Gum disease (periodontal disease) is one of the most common causes of tooth loss in adults. Natural Dental Clinic offers gum treatments including scaling and root planing to help manage gum disease at various stages.",
    symptoms: [
    ...
    process: [
      ...
      { step: "Therapy", description: "Targeted treatment to promote gum tissue healing." },
      { step: "Antimicrobial Treatment", description: "Antibiotics or antimicrobial rinses may be prescribed to support healing." },
      { step: "Maintenance Program", description: "A personalised hygiene maintenance schedule to help keep gum disease managed." },
    ],
    faqs: [
      { question: "Is gum disease reversible?", answer: "Early gum disease (gingivitis) is reversible with proper treatment. Advanced cases (periodontitis) can be managed and stabilised but not fully reversed." },
      ...
      { question: "Can gum disease affect my overall health?", answer: "Yes. Research links gum disease to heart disease, diabetes, and other systemic conditions. Managing it supports whole-body health." },
  ...
  },
  {
    ...
    category: "Restorative",
    description: "High-quality dental crowns and bridges designed to restore damaged teeth and fill gaps beautifully.",
    overview:
      "Dental crowns cap and protect damaged, weakened, or root-treated teeth, helping restore their strength and appearance. Bridges replace one or more missing teeth using crowns on adjacent teeth as anchors. At Natural Dental Clinic, we use high-quality materials for crowns and bridges that look natural.",
    symptoms: [
    ...
    benefits: [
      ...
      "Fills gaps to support smile and function",
    ...
    process: [
      ...
      { step: "Tooth Preparation", description: "The tooth is shaped to accommodate the crown. Local anaesthesia supports comfort." },
    ...
    faqs: [
      ...
      { question: "Will a crown look natural?", answer: "Yes. We use tooth-coloured porcelain or ceramic materials designed to blend seamlessly with natural teeth." },
  ...
  },
  {
    ...
    category: "Preventive",
    description: "Comprehensive preventive and general dental care to support healthy teeth and gums for life.",
    overview:
    ...
    faqs: [
      ...
      { question: "Are fillings noticeable?", answer: "We use tooth-coloured composite resin fillings designed to match your natural tooth colour." },
      { question: "Is preventive care important even if I have no pain?", answer: "Yes! Many dental issues are painless until advanced. Regular check-ups catch problems early when they are easiest to address." },
    ],
